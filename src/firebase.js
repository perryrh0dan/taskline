...
const cert = {
  ...
  client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-86yi4%40todo-83ef9.iam.gserviceaccount.com"
};
...
class FirebaseStorage extends Storage {
  ...
  async getArchive() {
    if (!this.archive) {
      await this._getCollection("archive")
    }
    return this.archive
  }
